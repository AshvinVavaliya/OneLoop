...
/**
 * Returns a [AppColorScheme] based on [darkTheme]
 */
...
/**
 * Chooses a [Color] based on [Boolean] from [AppColorToken]
 *
 ...
 */
internal val LocalAppColorScheme = staticCompositionLocalOf { colorScheme(true) }
